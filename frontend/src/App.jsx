        ...
        {isMobileMenuOpen && (
          <div className="md:hidden absolute top-full left-0 w-full bg-white shadow-lg z-20 animate-fade-in-up">
            <div className="px-4 pt-2 pb-4 space-y-1">
              <button
                onClick={() => handleNavClick('home')}
                className={`block w-full text-left px-3 py-2 rounded-md text-base font-medium ${view === 'home' ? 'bg-[#2A7EF9]/10 text-primary' : 'text-gray-700 hover:text-gray-900 hover:bg-gray-50'}`}
              >
                Home
              </button>
              <button
                onClick={() => handleNavClick('questionnaire')}
                className={`block w-full text-left px-3 py-2 rounded-md text-base font-medium ${view === 'questionnaire' || view === 'results' ? 'bg-[#2A7EF9]/10 text-primary' : 'text-gray-700 hover:text-gray-900 hover:bg-gray-50'}`}
              >
                Find suitable Mutual funds
              </button>
              <button
                onClick={() => handleNavClick('sip')}
                className={`block w-full text-left px-3 py-2 rounded-md text-base font-medium ${view === 'sip' ? 'bg-[#2A7EF9]/10 text-primary' : 'text-gray-700 hover:text-gray-900 hover:bg-gray-50'}`}
              >
                SIP Calculator
              </button>
              <button
                onClick={() => handleNavClick('swp')}
                className={`block w-full text-left px-3 py-2 rounded-md text-base font-medium ${view === 'swp' ? 'bg-[#2A7EF9]/10 text-primary' : 'text-gray-700 hover:text-gray-900 hover:bg-gray-50'}`}
              >
                SWP Calculator
              </button>
              <button
                onClick={() => handleNavClick('realReturns')}
                className={`block w-full text-left px-3 py-2 rounded-md text-base font-medium ${view === 'realReturns' ? 'bg-[#2A7EF9]/10 text-primary' : 'text-gray-700 hover:text-gray-900 hover:bg-gray-50'}`}
              >
                Real Returns Calculator
              </button>
            </div>
